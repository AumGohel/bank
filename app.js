...
const c3 = new Customer({
    name : "Shivani",
    email : "shivani@yahoo.com",
    Amount : 12000
});

const c4 = new Customer({
    name : "Shivam",
    email : "shivam@hotmail.com",
    Amount : 40000
});
...
const c6 = new Customer({
    name : "Ram",
    email : "ram_034@yahoo.com",
    Amount : 90000
});

const c7 = new Customer({
    name : "Lakshman",
    email : "lakshman__@gmail.com",
    Amount : 50000
});

const c8 = new Customer({
    name : "Amit",
    email : "amit240@gmail.com",
    Amount : 15000
});

const c9 = new Customer({
    name : "Yash",
    email : "yashdsj@gmail.com",
    Amount : 500000
});

const c10 = new Customer({
    name : "Priyanka",
    email : "priyankabankar75@gmail.com",
    Amount : 10000
});
